        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Explore our network of certified organic farms where your investments grow 
              and premium produce is cultivated using sustainable practices.
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-8 left-8 text-white">
                <h3 className="text-2xl md:text-3xl font-bold mb-2">Valley Green Farms</h3>
                <p className="text-lg opacity-90">1,200 acres of certified organic farmland</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm opacity-90 mb-4">
                  Our farms use regenerative agriculture techniques that improve soil health 
                  and increase biodiversity while maximizing yields.
                </p>
                <div className="flex items-center space-x-2">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm opacity-90 mb-4">
                  Advanced monitoring systems and precision farming techniques ensure 
                  optimal growing conditions and maximum investment returns.
                </p>
                <div className="flex items-center space-x-2">
          ...
          <div className="text-center mt-16">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
                Whether you're looking to invest in sustainable agriculture or purchase premium 
                organic produce in bulk, we have the perfect solution for you.
              </p>
