...
const NewInvestment = () => {
  ...
  return (
    <div className="bg-[#5d9632] min-h-screen p-6 sm:p-10">
      <h1 className="text-5xl font-semibold mb-6 text-white swatson">New Investment</h1>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-100 rounded-lg p-6  shadow-md">
          ...
          <div className="mb-4 joseph">
            ...
            <input type="text" className="w-full mt-1 px-3 py-2 rounded border" placeholder="Enter name" />
          </div>

          <div className="mb-4 joseph">
            <label className="font-medium text-m">Project Description</label>
            <input type="text" value="Cocoa Trade" readOnly className="w-full mt-1 px-3 py-2 rounded border bg-gray-200" />
          </div>
          ...
          <div className="mb-4 joseph">
            ...
            <textarea placeholder="Anything we should know?" className="w-full mt-1 px-3 py-2 rounded border" />
            ...
            <label className="font-medium text-m">Payment Method</label>
             ...
             <div className="flex gap-3 border py-2 px-2 rounded w-45">
              ...
              <label><img src={paylogo1} alt="" className='w-55 h-10' /></label>
                </div>
          </div>

          <div className="flex items-center joseph mb-4 text-m">
            <input type="checkbox" className="mr-2" />
            <label>I acknowledge the <a href="#" className="text-blue-600 underline">Terms and Conditions</a></label>
          </div>

          <div className="flex gap-4">
            <button className="bg-[#7DB636] text-white px-6 py-2 rounded hover:bg-green-700">Pay Now</button>
            <button className="bg-red-500 text-white px-6 py-2 rounded hover:bg-red-600">Cancel</button>
          </div>
        </div>

        {/* Right Side: Summary */}
       <div className="bg-gray-100 rounded-lg p-6 shadow-md border h-100 border-gray-300 mb-6">
  <h2 className="text-2xl font-semibold swatson mb-4">Investment Financial Summary</h2>
  ...
  <table className="w-full text-sm text-left text-gray-700">
    <tbody className="divide-y divide-gray-300">
      ...
      <tr>
        <td className="py-2 font-medium">Cost of Production per Unit</td>
      ...
      <tr className="bg-green-50 font-semibold">
        <td className="py-2 text-lg text-black font-bold">Grand Total Payable</td>
        <td className="text-[#0A6534] text-xl">₵{totalPayable.toFixed(2)}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td className="py-2 font-bold text-black text-lg">Potential ROI (₵)</td>
        <td className="text-[#0A6534] text-xl">{profitMin.toFixed(2)} - {profitMax.toFixed(2)}</td>
      </tr>
    </tbody>
  </table>
